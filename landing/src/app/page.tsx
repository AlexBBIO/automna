...
// Integration logos for the landing page
const integrations = [
  ...
  { name: 'Spotify', icon: '/integrations/spotify.svg' },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white antialiased transition-colors">
      ...
      <main className="relative z-10">
        ...
        <section className="container mx-auto px-6 py-8 md:py-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-zinc-500 dark:text-zinc-400">Chat from anywhere. Integrate with everything.</p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              {integrations.map((integration) => (
                <div
                  ...
                  className="flex flex-col items-center gap-2 p-4 bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/50 rounded-xl hover:border-zinc-300 dark:hover:border-zinc-700/60 hover:shadow-md transition-all duration-200"
                >
                  <img 
        ...
        {/* Final CTA */}
        <section className="container mx-auto px-6 py-10 md:py-14 bg-zinc-50/50 dark:bg-zinc-900/30">
