        ...
        <section className="container mx-auto px-6 pt-12 pb-16 md:pt-20 md:pb-24">
          <div className={`max-w-3xl mx-auto text-center transform transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            {!submitted ? (
              <div className="max-w-lg mx-auto">
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 mb-4">
                  <input
                    ...
                    required
                    className="flex-1 px-4 py-3.5 rounded-lg bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-purple-400 dark:focus:border-purple-500/50 focus:ring-2 focus:ring-purple-100 dark:focus:ring-0 dark:focus:bg-white/[0.07] transition-all text-base shadow-sm dark:shadow-none"
                  />
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-medium transition-all disabled:opacity-50 shadow-lg shadow-purple-200 dark:shadow-purple-500/25 hover:shadow-purple-300 dark:hover:shadow-purple-500/40 text-base whitespace-nowrap"
                  >
              ...
              <div className="max-w-md mx-auto bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-500/10 dark:to-violet-500/10 border border-purple-200 dark:border-purple-500/20 rounded-xl p-6">
                <div className="text-3xl mb-3">🎉</div>
                <p className="text-lg font-medium text-zinc-900 dark:text-white mb-1">You&apos;re #{waitlistCount + 1} on the list!</p>
                <p className="text-zinc-500 dark:text-zinc-400 text-sm mb-4">We&apos;ll email you when it&apos;s your turn.</p>
        ...
        <section className="container mx-auto px-6 py-20 md:py-28">
          <div className="max-w-xl mx-auto text-center">
            ...
            {!submitted ? (
              <>
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 mb-6">
                  <input
                    ...
                    placeholder="you@company.com"
                    required
                    className="flex-1 px-4 py-3.5 rounded-lg bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-purple-400 dark:focus:border-purple-500/50 focus:ring-2 focus:ring-purple-100 dark:focus:ring-0 transition-all text-base shadow-sm dark:shadow-none"
                  />
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-medium transition-all disabled:opacity-50 shadow-lg shadow-purple-200 dark:shadow-purple-500/25 text-base whitespace-nowrap"
                  >
                    {loading ? 'Joining...' : 'Get Early Access'}
                  </button>
                </form>
                ...
                <div className="flex items-center justify-center gap-4">
                  <span className="text-zinc-400 dark:text-zinc-600 text-sm">or continue with</span>
                  <button className="flex items-center gap-2 px-4 py-2 bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-lg text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-white/10 transition-colors">
              ...
              <p className="text-purple-600 dark:text-purple-400 text-lg font-medium">You&apos;re on the list! ✓</p>
            )}
          </div>
        </section>
      </main>
